            ...
            <nav class="navbar navbar-transparent navbar-absolute">
                <div class="container-fluid">
                    <div class="navbar-header">
                        ...
                        <a class="navbar-brand" href="#"> Modifier chambre </a>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-8">
                            <div class="card">
                                <div class="card-header" data-background-color="purple">
                                    <h4 class="title">Modifier la chambre ${ chambre.idChambre }</h4>
                                    	...
                                    	<div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group label-floating">
                                                    <label class="control-label">Numéro de la chambre</label>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group label-floating">
                                                    ...
                                                    <input type="text" name="taille" value="${ chambre.taille }" class="form-control" readonly="readonly" />
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-1">
                                                <div class="form-group label-floating">
                                                    ...
                                                    <input type="checkbox" id="c" name="climatisation" class="form-control">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <div class="form-group label-floating">
                                                        ...
                                                        <textarea name="description" class="form-control" rows="3">${ chambre.description }</textarea>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                        ...
                        <div class="col-md-4">
                            <div class="card card-profile">
                                ...
                                <div class="content">
                                    <h4 class="card-title">${ chambre.categorie }</h4>
                                    <h6 class="category text-gray">${ chambre.taille }m²</h6>
